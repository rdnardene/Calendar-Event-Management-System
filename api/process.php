...
function bookCalendar() {
	...
	*/
	...
	$sql = "INSERT INTO tbl_reservations (uid, ucount, rdate, status, comments, bdate, Event_Name, department) 
			VALUES ($userId, $ucount, '$bkdate', 'PENDING', '', NOW(),'$eventname', '$department')";
	dbQuery($sql);

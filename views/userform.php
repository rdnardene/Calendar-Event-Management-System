...
var sprytf_name 	= new Spry.Widget.ValidationTextField("sprytf_name", 'none', {minChars:1, validateOn:["blur", "change"]});
var sprytf_address 	= new Spry.Widget.ValidationTextarea("sprytf_address", {minChars:1, isRequired:true, validateOn:["blur", "change"]});

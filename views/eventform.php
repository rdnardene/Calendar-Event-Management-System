  ...
  <form role="form" action="<?php echo WEB_ROOT; ?>api/process.php?cmd=book" method="post">
    <div class="box-body">
      <div class="form-group">
        <label for="exampleInputEmail1">Event Host</label>
	  ...
	  <div class="form-group">
        ...
        <textarea name="address" class="form-control input-sm" placeholder="Venue" id="address"></textarea>
	  ...
	  <div class="form-group">
        ...
        <select type="text" name="department" class="form-control input-sm" placeholder="Enter Department" id="department">
		<span class="textfieldRequiredMsg">Department ID is required.</span>
	  ...
	  <div class="form-group">
        <label for="exampleInputPassword1">Event Description/Name</label>
		<span id="sprytf_event">
        <input type="text" name="eventname" class="form-control input-sm" placeholder="Description/Name" >
		<span class="textfieldRequiredMsg">Event Name/Description is required.</span>
		<span class="textfieldInvalidFormatMsg">Invalid Format.</span>
      </div>
    <!-- /.box-body -->
